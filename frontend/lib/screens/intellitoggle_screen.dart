...
/// Live demo of IntelliToggle — Aortem's feature-flag SaaS — exercised through
/// the full OpenFeature client surface (OAuth2 client-credentials).
...
class _IntelliToggleScreenState extends State<IntelliToggleScreen> {
  ...
  void initState() {
    ...
    _targetingRows.add(_AttrRow('targetingKey', s.userId ?? s.email ?? 'anonymous'));
  ...
  Widget build(BuildContext context) {
    ...
    if (_registering) return const Center(child: CircularProgressIndicator());
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Supply OAuth2 client-credentials at build time:\n\n'
          ...
          children: [
            ...
            Row(
              children: [
                TextButton.icon(
                  onPressed: () =>
                      setState(() => _targetingRows.add(_AttrRow('', ''))),

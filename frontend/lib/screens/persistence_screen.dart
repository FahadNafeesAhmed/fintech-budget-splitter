...
class PersistenceScreen extends StatelessWidget {
  ...
  ResourceCrudSection _crud({
    ...
    return ResourceCrudSection(
      ...
      titleOf: titleOf,
      fetch: () => s.client!.persistence.list(path, session: s.dsSession!),
      onCreate: (v) async =>
          s.client!.persistence.create(path, session: s.dsSession!, body: body(v)),
    ...
    return ListView(
      ...
      children: [
        ...
        _crud(
          ...
          titleOf: (m) =>
              (m['bucket_name'] ?? m['bucketName'] ?? m['id']).toString(),
        ),
        _crud(
          ...
          titleOf: (m) =>
              (m['provider_type'] ?? m['providerType'] ?? m['id']).toString(),
        ),
